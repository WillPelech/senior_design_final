...
# PS1 (Car 1) — blue square  (H=101 S=255 V=182, high S to avoid teal surface)
PS1_HSV_LOW  = [96,  220, 120]
...
SHAPE_CLOSE_AREA = 300000  # px² — stop and act when shape this large in frame
